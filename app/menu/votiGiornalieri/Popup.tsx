...
const Popup = ({
	...
	<div className="fixed left-0 right-0 top-0 bottom-0 z-10 w-full h-full bg-zinc-900 bg-opacity-75 blockScroll">
		<div
			className="absolute sm:left-0 sm:right-0 mx-auto w-full h-full sm:w-1/2 sm:min-w-96 sm:h-fit sm:max-h-full top-1/2 border-zinc-500 sm:rounded-xl bg-zinc-200 dark:bg-zinc-800 overflow-y-auto p-6 sm:-translate-y-1/2 text-left popup"
			onClick={(event) => {
		...
		>
			<div className="flex flex-row w-full justify-between">
				<div className="flex flex-col">
					<span className={`${medium.className} uppercase`}>
						{voto.docente}
					</span>
